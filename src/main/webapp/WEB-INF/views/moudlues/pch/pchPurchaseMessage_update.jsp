	   ...
	   <input type="hidden" value="${nowDate}" name="updateDate" id="updateDate">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${pchPurchaseMessage.name}" placeholder="" id="name" name="name" >
			</div>
		</div>
		<div class="row cl">
			...
			<select name="purchaseType.id" class="select">
			       <option value="${purchaseType.id }">${pchPurchaseMessage.purchaseType.name}</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="whWarehouse.id" class="select" onchange="getComputingUnit()" id="whWarehouse">
				     <option value='${pchPurchaseMessage.whWarehouse.id}'>${pchPurchaseMessage.whWarehouse.name}</option>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="originPlace" id="originPlace" placeholder="" value="${pchPurchaseMessage.originPlace}" class="input-text">
			</div>
		</div>
		<!-- <div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="supplier" id="supplier" placeholder="" value="${pchPurchaseMessage.originPlace}" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">购买的数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="num" id="num" placeholder="" value="${pchPurchaseMessage.num}" class="input-text">
				<input type="text" name="computingUnit" id="computingUnit" placeholder="" value="${pchPurchaseMessage.whWarehouse.computingUnit}" class="input-text" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="spend" id="spend" placeholder="" value="${pchPurchaseMessage.spend}" class="input-text" style="width:90%">
				元</div>
		</div>
	   <%--  <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">采购开始时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'purchaseEndDate\')||\'%y-%M-%d\'}' })" id="purchaseStartDate" name="purchaseStartDate" class="input-text Wdate" style="width:120px;" value="${pchPurchaseMessage.purchaseStartDate}" >
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">采购结束时间：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({ minDate:'#F{$dp.$D(\'purchaseStartDate\')}',maxDate:'%y-%M-%d' })" id="purchaseEndDate" name="purchaseEndDate" class="input-text Wdate" style="width:120px;" value="${pchPurchaseMessage.purchaseEndDate}">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="remark" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="$.Huitextarealength(this,200)">${pchPurchaseMessage.remark}</textarea>
