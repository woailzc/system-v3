...
<div class="page-container">
	<form action="<%=basePath%>/a/pchPurchaseMessage/apply.do" method="post" class="form form-horizontal" id="form-article-add">
	     ...
	     <input type="hidden" value="审核" name="status" id="status">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>申请的名称：</label>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">申请的规格：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="Specifications" id="Specifications" placeholder="" value="" class="input-text">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">申请的型号：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
<!-- 				<input type="text" name="computingUnit" id="computingUnit" placeholder="" value="" class="input-text" readonly="readonly">
 -->			</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">申请的数量：</label>
			<div class="formControls col-xs-8 col-sm-9">
...
<!-- 				<input type="text" name="computingUnit" id="computingUnit" placeholder="" value="" class="input-text" readonly="readonly">
 -->			</div>
	    ...
	    <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({ maxDate:'#F{$dp.$D(\'purchaseStartDate\')||\'%y-%M-%d\'}' })" id="purchaseStartDate" name="purchaseStartDate" class="input-text Wdate" style="width:120px;" >
			</div>
		</div>
