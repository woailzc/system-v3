...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<%=basePath%>static/lib/hcharts/Highcharts/5.0.6/js/highcharts.js"></script>
<script type="text/javascript" src="<%=basePath%>static/lib/hcharts/Highcharts/5.0.6/js/modules/exporting.js"></script>
<script type="text/javascript" src="<%=basePath%>static/lib/hcharts/Highcharts/5.0.6/js/highcharts-3d.js"></script>
 <input type="hidden" value="${astWorkingCapital}" name="astWorkingCapital" id="astWorkingCapital" >
 <input type="hidden" value="${astSpecialCapital}" name="astSpecialCapital" id="astSpecialCapital">
 <input type="hidden" value="${astFixedCapital}" name="astFixedCapital" id="astFixedCapital">
<script type="text/javascript">
﻿﻿$(function () {
	 var astFixedCapital = $("#astFixedCapital").val();
	 var astSpecialCapital = $("#astSpecialCapital").val();
	 var astWorkingCapital = $("#astWorkingCapital").val();
...
<script type="text/javascript">
﻿﻿$(function () {
	 var astFixedCapital = parseFloat($("#astFixedCapital").val()); /* alert(astFixedCapital); return false; */
	 var astSpecialCapital = parseFloat($("#astSpecialCapital").val());
	 var astWorkingCapital = parseFloat($("#astWorkingCapital").val());
	  /* alert(astFixedCapital+astSpecialCapital+astWorkingCapital); return false;  */
    $('#container').highcharts({
        chart: {
            type: 'pie',
            options3d: {
        ...
        series: [{
            ...
            name: 'Browser share',
            data: [
                ['astFixedCapital',   astFixedCapital],
                ['astSpecialCapital',       astSpecialCapital],
               /*  {
                    name: 'Chrome',
                    y: 12.8,
                    sliced: true,
                ...
                ['astWorkingCapital',    astWorkingCapital]
                /* ['Opera',     6.2],
                ['Others',   0.7] */
            ]
        }]
