	...
	<form action="<%=basePath%>/a/whWarehouse/update.do" method="post" class="form form-horizontal" id="form-member-add">
	   ...
	   <input type="hidden" value="${param.id }" name="id" id="id"> 
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" onKeyUp="$.Huitextarealength(this,100)"id="remark" name="remark" value="${whWarehouse.remark }"></textarea>
