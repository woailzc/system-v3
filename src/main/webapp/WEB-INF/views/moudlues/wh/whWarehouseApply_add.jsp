...
<article class="page-container">
	<form action="<%=basePath%>/a/whWarehouseApply/save.do" method="post" class="form form-horizontal"  enctype="multipart/form-data">
		...
		<input type="hidden" value="申请中" name="suggestion" id="suggestion">
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>申请的仓库：</label>
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="whWarehouse.id" id="whWarehouse.id" required="required">
					<option value="" selected>请选择空闲的仓库</option>
