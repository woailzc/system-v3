...
<article class="page-container">
	<form action="<%=basePath%>/a/sysUser/update.do" method="post" class="form form-horizontal" id="form-add">
	   <input type="hidden" value="${currentSysUser.id }" name="updateBy.id" id="updateBy.id">
	   ...
	   <input type="hidden" value="${sysUser.id }" name="id" id="id">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			    <input type="hidden" name="sysODepartment.id" id="sysODepartment.id" value="${sysUser.sysDepartment.id }">
				<input type="text" class="input-text" value="${sysUser.sysDepartment.name }" placeholder="" id="sysDepartment.name" name="sysDepartment.name" readonly="readonly">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>角色：</label>
			<div class="formControls col-xs-8 col-sm-9">
			    <input type="hidden" name="sysORole.id" id="sysORole.id" value="${sysUser.sysRole.id }">
				<input type="text" class="input-text" value="${sysUser.sysRole.name }" placeholder="" id="sysRole.name" name="sysRole.name"  readonly="readonly">
			</div>
		</div>
		<div class="row cl">
