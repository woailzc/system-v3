...
<article class="page-container">
	<form action="<%=basePath%>/a/sysPermission/save.do" method="post" class="form form-horizontal"  enctype="multipart/form-data">
	    <input type="hidden" value="${sysUser.id}" name="createBy.id" id="createBy.id" >
	     ...
	     <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1"  id="fatherMenu" >
					<option value="" selected>请选择一级菜单</option>
					<c:forEach items="${sysMenus }" var="sysMenu">
					<option value="${sysMenu.id }">${sysMenu.menuName }</option>
					</c:forEach>
				</select>
				</span> 
				</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select class="select" size="1" name="sysMenu.id" id="sysMenu" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="remark" name="remark" required="required">
			</div>
		</div>
		<div class="row cl">
